...
parser.add_argument('--third_party_DOIs_file', default='{}/{}'.format(os.environ['PWD'], 'lists/third_party_series_mvp_wave1.json'),
                    help='Table of series/DOI pairs ')
parser.add_argument('--exclude', default='{}/{}'.format(os.environ['PWD'], 'lists/excluded_mvp_wave1.txt'),
                    help='File containing list of DOIs to exclude; Excluse none if not specified')
