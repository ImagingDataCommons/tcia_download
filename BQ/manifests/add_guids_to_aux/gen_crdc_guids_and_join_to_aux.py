...
def join_guids_to_aux_table(args):
    ...
    result = query_BQ(BQ_client, args.dst_bqdataset_name, args.aux_dst_table, sql, 'WRITE_TRUNCATE')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--temp_blob_manifest_table', default='tmp_crdc_blob_manifest', \
                         help='Temporary BQ table holding crdc blob manifests')
    parser.add_argument('--temp_series_bundle_manifest_table', default='tmp_crdc_series_bundle_manifest', \
                         help='Temporary BQ table holding crdc series bundle manifests')
    parser.add_argument('--temp_study_bundle_manifest_table', default='tmp_crdc_study_bundle_manifest', \
    ...
    parser.add_argument('--dst_bqdataset_name', default='mvp_wave2', help='Destination BQ dataset name')
