...
if __name__ == '__main__':
    ...
    parser.add_argument('--initial', '-i', type=int, default=1, help="Index in tasks file of first collection to download, 0 based")
    parser.add_argument('--count', '-c', type=int, default=1, help='Number of collections to download from initial')
    parser.add_argument('--workers', '-w', type=int, help='Number of worker processes in a task (on a VM)', default=4)
    parser.add_argument('--ref', '-r', default='', help='Prefix of reference collection buckets against which to validate. Empty string -- no validation')
