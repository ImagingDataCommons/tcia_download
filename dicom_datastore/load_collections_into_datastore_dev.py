...
parser.add_argument('--collections', default='all', help='Collections to import into DICOM store')
parser.add_argument('--region', default='us-central1', help='Dataset region')
parser.add_argument('--dataset_name', default='idc_tcia_dev', help='Dataset name')
parser.add_argument('--datastore_name', default='idc_tcia', help='Datastore name')
